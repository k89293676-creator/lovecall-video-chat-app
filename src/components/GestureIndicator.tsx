...
export function GestureIndicator({ gesture }: Props) {
  ...
  return (
    <div
      key={animKey}
      className={`fixed top-20 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 px-5 py-2.5 rounded-2xl border backdrop-blur-lg shadow-2xl animate-in fade-in zoom-in-90 duration-200 ${color}`}
    >
